...
<p>
<br>
<input type="checkbox" value="1" name="chkMove">1.商品
<br><input type="checkbox" value="2" name="chkMove">2.商品
<br><input type="checkbox" value="3" name="chkMove">3.商品
<br><input type="checkbox" value="4" name="chkMove">4.商品
<br><input type="checkbox" value="5" name="chkMove">5.商品
</p>
