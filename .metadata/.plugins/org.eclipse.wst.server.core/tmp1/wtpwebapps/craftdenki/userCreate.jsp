...
メールアドレス:<input type="email" name="mail"value="<s:property value="mail"/>" placeholder="info@example.com"/><br>
...
答え:<input type="text" name="secretAnswer" value="<s:property value="secretAnswer"/>"><br>
郵便番号(7桁):<input type="text" name="yuubin" value="<s:property value="yuubin"/>"size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');"><br>
住所:<input type="text" name="address" value="<s:property value="address"/>" size="60"><br>
電話番号:<input type="text" name="tel" value="<s:property value="tel"/>" required>
<s:submit value="登録"/>
</s:form>
