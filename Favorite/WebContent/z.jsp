...
<head>
<title>全てのチェックボックスのチェックを外す</title>
<script Language="JavaScript"><!--
function checkCB()
{
	for (i=1; i<5; i++) document.myFORM.elements["myCHK"+i].checked = false;
}
// --></script>
</head>
...
<td>商品名</td><td>画像</td><td>値段</td><td>会社</td><td>発売月</td>
	...
	<form name="frmMove">
		...
		<p>
			...
			<br>
			<input type="checkbox" value="3" name="chkMove">2.画像 <br>
			<input type="checkbox" value="5" name="chkMove">3.値段<br>
			<input type="checkbox" value="6" name="chkMove">4.会社<br>
			<input type="checkbox" value="7" name="chkMove">5.発売月
		</p>
		...
		<p>
			...
			<INPUT TYPE="button" VALUE="商品一覧へ戻る"
				...
				TYPE="button" VALUE="削除" onClick="chkMove">
